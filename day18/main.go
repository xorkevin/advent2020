...
func parseParen(tokens []Token) (Expr, []Token, error) {
...
func parseVal(tokens []Token) (Expr, []Token, error) {
	if len(tokens) == 0 {
		return nil, nil, fmt.Errorf("EOF")
	}
	i := tokens[0]
...
func parseParen2(tokens []Token) (Expr, []Token, error) {
...
func parseVal2(tokens []Token) (Expr, []Token, error) {
	if len(tokens) == 0 {
		return nil, nil, fmt.Errorf("EOF")
	}
	i := tokens[0]
...
func parseAddExpr2(tokens []Token) (Expr, []Token, error) {
...
func parseExpr2(tokens []Token) (Expr, []Token, error) {
